// Solutions for Lab 10: Bit-Flip Error Correction
// Copyright 2021 The MITRE Corporation. All Rights Reserved.

namespace QSharpExercises.Solutions.Lab10 {
    ...
    operation Exercise3 (
        ...
        // first qubit flipped
        if (
            syndromeMeasurement[0] == One and
            syndromeMeasurement[1] == One
        ) {
            X(register[0]);
        }
        ...
        // third qubit flipped
            ...
            syndromeMeasurement[0] == Zero and
            syndromeMeasurement[1] == One
        ) {
            X(register[2]);
        }
