// Solutions for Lab 6: Grover's Algorithm
// Copyright 2021 The MITRE Corporation. All Rights Reserved.

namespace QSharpExercises.Solutions.Lab6 {
    ...
    operation Exercise3 (
        ...
        // If the key is correct, then original XOR key = encrypted
        Exercise1(originalMessage, candidateEncryptionKey);

        // Encrypted XOR encrypted = 0, so do this and check if it's zero
